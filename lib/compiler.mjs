 ...
 * @param {boolean} config.parseUnicode - indicates whether is to use unicode parse on the HTML output
 * @returns {CompiledEmail[]} resulting emails
 */
export async function compile ({ inputs, sassPath, minify, parseUnicode }) {
  const styles = [
    LOCAL_STYLES,
